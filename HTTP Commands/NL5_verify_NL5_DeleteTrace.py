"""Step 15 verification: NL5_DeleteTrace

Objective:
  Delete the transient trace at index 2.

Command template from doc:
  http://localhost/?NL5_DeleteTrace,2
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_DeleteTrace,2"
