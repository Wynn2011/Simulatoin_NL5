"""Step 13 verification: NL5_GetTracesSize

Objective:
  Get the total number of traces in the current transient simulation.

Command template from doc:
  http://localhost/?NL5_GetTracesSize
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_GetTracesSize"
