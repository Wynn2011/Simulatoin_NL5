"""Step 41 verification: NL5_GetACTraceValue

Objective:
  Get the value of AC trace 0 at 1000Hz.

Command template from doc:
  http://localhost/?NL5_GetACTraceValue,0,1000
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_GetACTraceValue,0,1000"
