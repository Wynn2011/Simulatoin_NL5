"""Step verification: NL5_Save

Objective:
  Save the current active document as "backup.nl5".

Command template from doc:
  http://localhost/?NL5_Save,backup.nl5
...
def main() -> None:
    ...
    sc, body, url = http_get('?'+"NL5_Save,backup.nl5".lstrip('?'))
    print("NL5_Save:")
    print("  url:", url)
    print("  status:", sc)
    print("  body:", body)
