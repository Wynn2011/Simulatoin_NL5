"""Step 35 verification: NL5_Store

Objective:
  Store the current simulation data in a storage area named "Case1".

Command template from doc:
  http://localhost/?NL5_Store,Case1
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_Store,Case1"
