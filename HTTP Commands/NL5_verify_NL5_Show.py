"""Step verification: NL5_Show

Objective:
  Activate and display the schematic window for the document with handle 1.

Command template from doc:
  http://localhost/?NL5_Show,1
...
def main() -> None:
    ...
    sc, body, url = http_get('?'+"NL5_Show,1".lstrip('?'))
    print("NL5_Show:")
    print("  url:", url)
    print("  status:", sc)
    print("  body:", body)
