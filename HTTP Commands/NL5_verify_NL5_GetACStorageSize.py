"""Step 50 verification: NL5_GetACStorageSize

Objective:
  Get the number of stored historical AC data sets.

Command template from doc:
  http://localhost/?NL5_GetACStorageSize
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_GetACStorageSize"
