"""Step verification: NL5_IsRunning

Objective:
  Check simulation status and current simulation time.

Command template from doc:
  http://localhost/?NL5_IsRunning
...
def main() -> None:
    ...
    sc, body, url = http_get('?'+"NL5_IsRunning".lstrip('?'))
    print("NL5_IsRunning:")
    print("  url:", url)
    print("  status:", sc)
    print("  body:", body)
