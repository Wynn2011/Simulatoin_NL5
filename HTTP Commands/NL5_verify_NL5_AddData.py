"""Step 32 verification: NL5_AddData

Objective:
  Add a time/value pair (t=1, v=2.5) to a data-type trace.

Command template from doc:
  http://localhost/?NL5_AddData,Data1,1,2.5
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_AddData,Data1,1,2.5"
