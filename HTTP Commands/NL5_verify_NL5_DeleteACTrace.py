"""Step 39 verification: NL5_DeleteACTrace

Objective:
  Delete the AC trace named "Z(L1)".

Command template from doc:
  http://localhost/?NL5_DeleteACTrace,Z(L1)
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_DeleteACTrace,Z(L1)"
