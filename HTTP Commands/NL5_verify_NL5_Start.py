"""Step verification: NL5_Start

Objective:
  Start transient simulation with a step size of 1u.

Command template from doc:
  http://localhost/?NL5_Start,step=1u
...
def main() -> None:
    ...
    sc, body, url = http_get('?'+"NL5_Start,step=1u".lstrip('?'))
    print("NL5_Start:")
    print("  url:", url)
    print("  status:", sc)
    print("  body:", body)
