"""Step 36 verification: NL5_DeleteStorage

Objective:
  Delete all saved historical data.

Command template from doc:
  http://localhost/?NL5_DeleteStorage
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_DeleteStorage"
