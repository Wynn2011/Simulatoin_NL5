"""Step 44 verification: NL5_SetACScreen

Objective:
  Set the AC window to display dB on the vertical axis and set the start frequency to 10Hz.

Command template from doc:
  http://localhost/?NL5_SetACScreen,left=10,db=on
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_SetACScreen,left=10,db=on"
