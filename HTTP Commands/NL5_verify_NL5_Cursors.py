"""Step 21 verification: NL5_Cursors

Objective:
  Enable cursors and place the left cursor at the 0.05s position.

Command template from doc:
  http://localhost/?NL5_Cursors,on,left=0.05
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_Cursors,on,left=0.05"
