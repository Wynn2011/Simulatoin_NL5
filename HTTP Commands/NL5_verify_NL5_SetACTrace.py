"""Step 42 verification: NL5_SetACTrace

Objective:
  Set AC trace properties, such as hiding all AC traces.

Command template from doc:
  http://localhost/?NL5_SetACTrace,all,show=off
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_SetACTrace,all,show=off"
