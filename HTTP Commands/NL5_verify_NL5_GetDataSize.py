"""Step 29 verification: NL5_GetDataSize

Objective:
  Get the number of transient data points generated for trace "V(C1)".

Command template from doc:
  http://localhost/?NL5_GetDataSize,V(C1)
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_GetDataSize,V(C1)"
