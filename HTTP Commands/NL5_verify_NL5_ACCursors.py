"""Step 45 verification: NL5_ACCursors

Objective:
  Display cursors in the AC window and set the right cursor position to 100k.

Command template from doc:
  http://localhost/?NL5_ACCursors,on,right=100k
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_ACCursors,on,right=100k"
