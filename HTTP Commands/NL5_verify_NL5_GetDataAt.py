"""Step 30 verification: NL5_GetDataAt

Objective:
  Retrieve 50 raw data points of trace 0 starting from the 100th point.

Command template from doc:
  http://localhost/?NL5_GetDataAt,0,start=100,points=50
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_GetDataAt,0,start=100,points=50"
