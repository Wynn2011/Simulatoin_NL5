"""Step 52 verification: NL5_DeleteACStorage

Objective:
  Delete the specified 1st group of stored historical AC data.

Command template from doc:
  http://localhost/?NL5_DeleteACStorage,1
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_DeleteACStorage,1"
