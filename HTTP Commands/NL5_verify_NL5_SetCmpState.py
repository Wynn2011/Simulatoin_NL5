"""Step verification: NL5_SetCmpState

Objective:
  Set the initial state of switch Q1 to "short".

Command template from doc:
  http://localhost/?NL5_SetCmpState,Q1,short
...
def main() -> None:
    ...
    sc, body, url = http_get('?'+"NL5_SetCmpState,Q1,short".lstrip('?'))
    print("NL5_SetCmpState:")
    print("  url:", url)
    print("  status:", sc)
    print("  body:", body)
