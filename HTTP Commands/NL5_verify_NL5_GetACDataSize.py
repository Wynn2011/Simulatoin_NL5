"""Step 48 verification: NL5_GetACDataSize

Objective:
  Get the number of data points for AC trace at index 0.

Command template from doc:
  http://localhost/?NL5_GetACDataSize,0
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_GetACDataSize,0"
