"""Step 27 verification: NL5_SaveAsWithIC

Objective:
  Save as a new file "state.nl5" and save the current state as the initial condition for that file.

Command template from doc:
  http://localhost/?NL5_SaveAsWithIC,state.nl5
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_SaveAsWithIC,state.nl5"
