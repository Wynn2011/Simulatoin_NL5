"""Step verification: NL5_DisableCmp

Objective:
  Disable components S1 and S2.

Command template from doc:
  http://localhost/?NL5_DisableCmp,S1,S2
...
def main() -> None:
    ...
    sc, body, url = http_get('?'+"NL5_DisableCmp,S1,S2".lstrip('?'))
    print("NL5_DisableCmp:")
    print("  url:", url)
    print("  status:", sc)
    print("  body:", body)
