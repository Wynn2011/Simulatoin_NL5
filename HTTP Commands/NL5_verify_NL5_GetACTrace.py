"""Step 40 verification: NL5_GetACTrace

Objective:
  Get AC trace information based on index 1.

Command template from doc:
  http://localhost/?NL5_GetACTrace,1
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_GetACTrace,1"
