"""Step verification: NL5_Open

Objective:
  Open the simulation file named "power_stage.nl5".

Command template from doc:
  http://localhost/?NL5_Open,power_stage.nl5
...
def main() -> None:
    ...
    sc, body, url = http_get('?'+"NL5_Open,power_stage.nl5".lstrip('?'))
    print("NL5_Open:")
    print("  url:", url)
    print("  status:", sc)
    print("  body:", body)
