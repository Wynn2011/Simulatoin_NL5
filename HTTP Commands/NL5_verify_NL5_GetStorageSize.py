"""Step 34 verification: NL5_GetStorageSize

Objective:
  Get the number of stored historical data sets for transient simulation.

Command template from doc:
  http://localhost/?NL5_GetStorageSize
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_GetStorageSize"
