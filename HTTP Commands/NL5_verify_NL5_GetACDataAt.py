"""Step 49 verification: NL5_GetACDataAt

Objective:
  Retrieve the frequency, magnitude, and phase of the first data point for trace "Z(C1)".

Command template from doc:
  http://localhost/?NL5_GetACDataAt,Z(C1),start=0,points=1
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_GetACDataAt,Z(C1),start=0,points=1"
