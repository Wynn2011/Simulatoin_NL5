"""Step 38 verification: NL5_AddACTrace

Objective:
  Add an impedance (Z) signal trace for component C1.

Command template from doc:
  http://localhost/?NL5_AddACTrace,Z,C1
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_AddACTrace,Z,C1"
