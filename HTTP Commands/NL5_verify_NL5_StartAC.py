"""Step 46 verification: NL5_StartAC

Objective:
  Specify V1 as the AC source and run a 100-point AC simulation from 10Hz to 1MHz.

Command template from doc:
  http://localhost/?NL5_StartAC,source=V1,from=10,to=1M,points=100
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_StartAC,source=V1,from=10,to=1M,points=100"
