"""Step 37 verification: NL5_GetACTracesSize

Objective:
  Get the total number of AC traces.

Command template from doc:
  http://localhost/?NL5_GetACTracesSize
...
def main() -> None:
    ...
    # Send command
    cmd = "http://localhost/?NL5_GetACTracesSize"
